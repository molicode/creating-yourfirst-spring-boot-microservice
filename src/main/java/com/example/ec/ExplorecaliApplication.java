...
public class ExplorecaliApplication implements CommandLineRunner {
  ...
  private void createTours(String fileToImport) throws IOException {
    TourFromFile.read(fileToImport)
        .forEach(tourFromFile -> tourService.createTour(tourFromFile.getTitle(), tourFromFile.getPackageName(), tourFromFile.getDetails()));
  }

  /**
   * Helper class to import ExploreCalifornia.json for a MongoDb Document. Only interested in the title and package name, the remaining
   * fields are a collection of key-value pairs
   */
